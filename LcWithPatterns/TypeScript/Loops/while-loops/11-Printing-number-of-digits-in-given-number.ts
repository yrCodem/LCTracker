...
let num: number = 123456789; // You can change this number to find the number of digits in any other number
let count: number = 0; // Start with 0 as we haven't counted any digits yet
