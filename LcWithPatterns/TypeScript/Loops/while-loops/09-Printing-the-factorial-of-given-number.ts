...
let n: number = 50; // You can change this number to calculate the factorial of any other number
let i: number = 1;
let factorial: number = 1; // Start with 1 as the factorial of 0 is 1
